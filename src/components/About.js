  ...
  return (
    <div className="about-section" id="about">
      <div className="about-content">
        ...
        <p>
          On a mission to make people's lives pain-free, FixHealth is dedicated to providing convenient and effective physiotherapy care. With over 1,00,000 successful sessions in 100+ cities, we bring relief to patients from metro to taluka places.
        </p>
        ...
        <div className="co-founder-section">
            ...
            <div className="co-founder-text">
              ...
              <p><a href="https://yourstory.com/2022/01/fixhealth-addresses-patients-pain-points-online">Click here to know more</a></p>
            </div>
        </div>
        </div>
      </div>
